...
public record PostDetails(string Id ,string Title, string Url, string HtmlContent, DateTime CreatedDate, string User, int Views, int CommentCount, bool? Rating, int Upvotes, int Downvotes);
